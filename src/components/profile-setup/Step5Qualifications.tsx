                                        ...
                                        <div key={item.id} className="p-3 border border-gray-200 rounded-md bg-white shadow-sm">
                                            <div className="flex justify-between items-start gap-4">
                                                ...
                                                <div className="flex space-x-2 flex-shrink-0">
                                                    <button type="button" onClick={() => openRoleSpecificEditor(item.id)} className="p-1 text-indigo-600 hover:text-indigo-800" aria-label={`Edit ${displayName} for ${category}`}> <FaEdit size={16} /> </button>
                                                    <button type="button" onClick={() => removeRoleSpecificQualification(item.id)} className="p-1 text-red-600 hover:text-red-800" aria-label={`Remove ${displayName} for ${category}`}> <FaTrash size={16} /> </button>
                                                </div>
                                            </div>
                                        </div>
                                    );
                    ...
                    return (
                        <div key={item.id} className="p-3 border border-gray-200 rounded-md bg-white shadow-sm">
                            <div className="flex justify-between items-start gap-4">
                                ...
                                <div className="flex space-x-2 flex-shrink-0">
                                    <button type="button" onClick={() => openMedicalEditor(item.id)} className="p-1 text-indigo-600 hover:text-indigo-800" aria-label={`Edit ${displayName}`}> <FaEdit size={16} /> </button>
                                    <button type="button" onClick={() => removeMedicalTraining(item.id)} className="p-1 text-red-600 hover:text-red-800" aria-label={`Remove ${displayName}`}> <FaTrash size={16} /> </button>
                                </div>
                            </div>
                        </div>
                    );
